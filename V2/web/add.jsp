        ...
        <div class="w mx-auto">
            ...
            <c:if test="${not empty newProductID}">
                <div class="alert alert-secondary alert-dismissible fade show" role="alert">
                    ...
                    <hr>
                    <p class="mb-0">View Added Product <a href="ProductDetailsServlet?ID=${newProductID}" class="alert-link">Here</a>.</p>
            ...
            <form action="AddProductServlet" method="post" class="validate">
                ...
                <button type="submit" class="btn btn-dark btn-block mt-4 mb-2">Add Product</button>
